...
tarea buscarTareaPorId(tarea **tareasPendientes, tarea **tareasRealizadas, int n, int id);
void menu(tarea **tareasPendientes, tarea **tareasRealizadas, int n);
...
int main(int argc, char const *argv[])
{
    ...
    menu(tareasPendientes,tareasRealizadas,n);
...
tarea buscarTareaPorId(tarea **tareasPendients, tarea **tareasRealizas, int n, int id)
{
    // int id=0;
...
void menu(tarea **tareasPendientes, tarea **tareasRealizadas, int n)
{
    ...
    {
    case 1:
        printf("Ingrese id que desesa buscar\n");
        scanf("%d", &id);
        tareaAux = buscarTareaPorId(tareasPendientes, tareasRealizadas, n, id);
        break;
    case 2:
        printf("Ingrese palabra que buscar:\n");
        fflush(stdin);
        char *palabra;
        palabra = (char *)malloc(100 * sizeof(char));
        gets(palabra);
